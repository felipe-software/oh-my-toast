            ...
            <ThemedView style={styles.container}>
                ...
                <ThemedView style={styles.sectionsWrapper}>
                    <Collapsible title="File-based routing">
                        ...
                        <ThemedText type="small">
                            The layout file in{" "}
                            <ThemedText type="code">src/app/_layout.tsx</ThemedText> sets up the tab
                            navigator.
                        </ThemedText>
                    ...
                    <Collapsible title="Android, iOS, and web support">
                        <ThemedView type="backgroundElement" style={styles.collapsibleContent}>
                            <ThemedText type="small">
                                ...
                                web version, press <ThemedText type="smallBold">w</ThemedText> in
                    ...
                    <Collapsible title="Images">
                        <ThemedText type="small">
                            ...
                            <ThemedText type="code">@3x</ThemedText> suffixes to provide files for
                    ...
                    <Collapsible title="Animations">
                        <ThemedText type="small">
                            ...
                            <ThemedText type="code">react-native-reanimated</ThemedText> library to
